...
EntityAddComponent2(me, "VariableStorageComponent", { _tags="accel_x_air", name = "accel_x_air", value_float = accel_air })
EntityAddComponent2(me, "VariableStorageComponent", { _tags="accel_x", name = "accel_x", value_float = accel })
